...
describe('DatatableComponent', () => {
  ...
  it('should calculate the columns if not set', () => {
    ...
    expect(component.columns[0].css).toBe('cb-text-no-overflow col-6');
    expect(component.columns[1].cols).toBe(6);
    expect(component.columns[1].css).toBe('cb-text-no-overflow flex-fill');
  });
  ...
  it('should not override col wide if set', () => {
    ...
    expect(component.columns[0].css).toBe('cb-text-no-overflow flex-fill');
    expect(component.columns[1].cols).toBe(5);
    expect(component.columns[1].css).toBe('cb-text-no-overflow col-5');
  });
  ...
  it('should not override a given css style for the column', () => {
    ...
    fixture.detectChanges();
    expect(component.columns[0].css).toBe('cb-text-no-overflow custom-style col-6');
  });
  ...
  it('should enlarge the first highest col setting if set cols are less than or equal to 12', () => {
    ...
    fixture.detectChanges();
    expect(component.columns[0].css).toBe('cb-text-no-overflow flex-fill');
    expect(component.columns[1].css).toBe('cb-text-no-overflow col-3');
  });
