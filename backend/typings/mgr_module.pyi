...
class OSDMap(ceph_module.BasePyOSDMap):
    ...
    def calc_pg_upmaps(self, inc: OSDMapIncremental, max_deviation: int, max_iterations: int = ..., pools: Optional[List[str]] = ...) -> int: ...
    ...
    @classmethod
    def build_simple(cls, epoch: int = ..., uuid: Optional[str] = ..., num_osd: int = ...): ...
...
class CLICommand:
    ...
    arg_spec: Any
    first_default: int
    def __init__(self, prefix: str, perm: str = ..., poll: bool = ...) -> None: ...
    KNOWN_ARGS: Any
    @staticmethod
    ...
    def call(self, mgr: Any, cmd_dict: Dict[str, Any], inbuf: Optional[str] = ...) -> HandleCommandResult: ...
...
class Option(Dict):
    def __init__(self, name: str, default: OptionValue = ..., type: OptionTypeLabel = ..., desc: Optional[str] = ..., long_desc: Optional[str] = ..., min: OptionValue = ..., max: OptionValue = ..., enum_allowed: Optional[List[str]] = ..., tags: Optional[List[str]] = ..., see_also: Optional[List[str]] = ..., runtime: bool = ...) -> None: ...

class Command(dict):
    prefix: Any
    handler: Any
    def __init__(self, prefix: str, handler: HandlerFuncType, perm: str = ..., poll: bool = ...) -> None: ...
    @staticmethod
    def returns_command_result(instance: Any, f: HandlerFuncType) -> Callable[..., HandleCommandResult]: ...
...
class MgrStandbyModule(ceph_module.BaseMgrStandbyModule, MgrModuleLoggingMixin):
    ...
    def get_module_option(self, key: str, default: OptionValue = ...) -> OptionValue: ...
    def get_ceph_option(self, key: str) -> OptionValue: ...
    def get_store(self, key: str) -> Optional[str]: ...
    def get_localized_store(self, key: str, default: Optional[str] = ...) -> Optional[str]: ...
    def get_active_uri(self) -> str: ...
    def get(self, data_name: str): ...
    def get_mgr_ip(self) -> str: ...
    def get_localized_module_option(self, key: str, default: OptionValue = ...) -> OptionValue: ...
...
class MgrModule(ceph_module.BaseMgrModule, MgrModuleLoggingMixin):
    ...
    class ClusterLogPrio(IntEnum):
        ...
        ERROR: int
    module_name: Any
    def __init__(self, module_name: str, py_modules_ptr: object, this_ptr: object) -> None: ...
    def __del__(self) -> None: ...
    @property
    def log(self) -> logging.Logger: ...
    ...
    def get_perf_schema(self, svc_type: str, svc_name: str) -> Dict[str, Dict[str, Dict[str, Union[str, int]]]]: ...
    def get_counter(self, svc_type: str, svc_name: str, path: str) -> Dict[str, List[Tuple[float, int]]]: ...
    def get_latest_counter(self, svc_type: str, svc_name: str, path: str) -> Dict[str, Union[Tuple[float, int], Tuple[float, int, int]]]: ...
    def list_servers(self) -> List[ServerInfoT]: ...
    def get_metadata(self, svc_type: str, svc_id: str, default: Optional[Dict[str, str]] = ...) -> Optional[Dict[str, str]]: ...
    def get_daemon_status(self, svc_type: str, svc_id: str) -> Dict[str, str]: ...
    def check_mon_command(self, cmd_dict: dict, inbuf: Optional[str] = ...) -> HandleCommandResult: ...
    def mon_command(self, cmd_dict: dict, inbuf: Optional[str] = ...) -> Tuple[int, str, str]: ...
    def send_command(self, result: CommandResult, svc_type: str, svc_id: str, command: str, tag: str, inbuf: Optional[str] = ...) -> None: ...
    def set_health_checks(self, checks: HealthChecksT) -> None: ...
    def handle_command(self, inbuf: str, cmd: Dict[str, Any]) -> Union[HandleCommandResult, Tuple[int, str, str]]: ...
    def get_mgr_id(self) -> str: ...
    ...
    def get_module_option(self, key: str, default: OptionValue = ...) -> OptionValue: ...
    def get_module_option_ex(self, module: str, key: str, default: OptionValue = ...) -> OptionValue: ...
    ...
    def get_store(self, key: str, default: Optional[str] = ...) -> Optional[str]: ...
    def get_localized_store(self, key: str, default: Optional[str] = ...) -> Optional[str]: ...
    ...
    def get_all_perf_counters(self, prio_limit: int = ..., services: Sequence[str] = ...) -> Dict[str, dict]: ...
